...
class ValidateFulfillmentMethodCourierConfiguration
{
    /**
    ...
    /**
     * Get the rules from the couriers fulfillment method setup.
     */
    protected function getRules(string $courier): array
    {
        return array_merge([
            'courier' =>  ['required', Rule::in(array_keys(Courier::getDrivers()))]
        ], Courier::getFulfillmentMethodConfiguration()[$courier]->rules() ?? []);
    }
